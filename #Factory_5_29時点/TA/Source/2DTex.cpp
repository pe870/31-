...
HRESULT cls2DTex::InitModel(float Width, float Height, float U, float V)
{
...
//テクスチャ作成.
HRESULT	cls2DTex::CreateTexture(LPSTR fileName, ID3D11ShaderResourceView** pTexture)
{
